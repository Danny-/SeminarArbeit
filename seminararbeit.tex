...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <Grundlegende Konzepte> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gk_eigennamen.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <Grundlegende Konzepte> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gk_koreferenzen.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <Grundlegende Konzepte> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gk_related.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <Coreferentially Enhanced Entity Frequency (CEEF)> %%
\section{Co-referentially Enhanced Entity Frequency (CEEF)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <CEEF - Basic> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{ceef_basic.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <CEEF - Formalisierung> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{ceef_formalisierung.tex}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <CEEF - Eliteness> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{ceef_eliteness.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <CEEF - Threshold> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{ceef_threshold.tex}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%% <CEEF - Poisson> %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{ceef_poisson.tex}
